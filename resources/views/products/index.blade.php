            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <th class="pt-0">Detail Produk</th>
                        <th class="pt-0">Gambar Produk</th>
                        <th class="pt-0">Ditambahkan Pada</th>
                        <th class="pt-0">Tindakan</th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('products.destroy',$val->id) }}" method="POST">
                                    {{ csrf_field()  }}
                                    @method('DELETE')
                                    <a class="btn btn-sm btn-success" href="{{route('products.show', $val->id)}}"><i data-feather="eye"></i> Tampilkan</a>
                                    <a class="btn btn-sm btn-warning" href="{{route('products.edit', $val->id)}}"><i data-feather="link"></i> Edit</a>
                                    <button class="btn btn-sm btn-danger" type="submit"><i data-feather="trash"></i> Hapus</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
