                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                        ...
                        <div class="row g-0 p-1">
                            ...
                            <div class="col-3 text-center">
                                <a href="https://calendar.google.com/calendar/u/0/r" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="calendar" class="icon-lg mb-1"></i><p class="tx-12">Calendar</p></a>
                            </div>
                            <div class="col-3 text-center">
